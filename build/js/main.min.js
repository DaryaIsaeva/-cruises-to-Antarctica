...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_2__["addSmoothScroll"])();
...
var menuToggleButton = document.querySelector('[data-main-nav="toggle"]');
var mainNav = document.querySelector('[data-main-nav]');
var mainWrapper = document.querySelector('[data-wrapper]');
var headerContainer = document.querySelector('[data-header="container"]');
var mainNavLink = document.querySelectorAll('[data-main-nav="link"]');
var isEscapeKey = function isEscapeKey(evt) {
  return evt.key === 'Escape';
};
var onMainNavLinkClick = function onMainNavLinkClick() {
...
var initMobileMenu = function initMobileMenu() {
  ...
  document.addEventListener('click', function (evt) {
    ...
    var isMenu = target === mainNav || mainNav.contains(target);
    var isMenuToggleButton = target === menuToggleButton;
    var menuIsOpen = mainNav.classList.contains('is-open');
...
/*!******************************!*\
  !*** ./js/modules/scroll.js ***!
  \******************************/
/*! exports provided: addSmoothScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addSmoothScroll", function() { return addSmoothScroll; });
var ANIMATION_TIME = 500;
var FRAMES_COUNT = 20;
var anchors = [].slice.call(document.querySelectorAll('[data-scroll]'));
