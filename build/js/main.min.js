...
/* harmony import */ var _modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-mobile-menu */ "./js/modules/init-mobile-menu.js");
/* harmony import */ var _modules_skroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/skroll */ "./js/modules/skroll.js");




var mainWrapper = document.querySelector('[data-wrapper]');
if (mainWrapper) {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_2__["initMobileMenu"])();
  Object(_modules_skroll__WEBPACK_IMPORTED_MODULE_3__["addSmoothSckroll"])();
...
var menuToggle = document.querySelector('[data-main-nav="toggle"]');
var mainNav = document.querySelector('[data-main-nav]');
var mainWrapper = document.querySelector('[data-wrapper]');
var headerContainer = document.querySelector('[data-header="container"]');
var mainBlockTitle = document.querySelector('[data-main-block="title"]');
var mainBlockText = document.querySelector('[data-main-block="text"]');
var onMenuToggleClick = function onMenuToggleClick() {
...
var initMobileMenu = function initMobileMenu() {
  ...
  document.addEventListener('click', function (evt) {
    var withinBoundaries = evt.composedPath().includes(mainNav);
    if (!withinBoundaries) {
      onMenuToggleClick();
    }
  });
...
/*!******************************!*\
  !*** ./js/modules/skroll.js ***!
  \******************************/
/*! exports provided: addSmoothSckroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addSmoothSckroll", function() { return addSmoothSckroll; });
var ANIMATION_TIME = 500;
var FRAMES_COUNT = 20;
var anchors = [].slice.call(document.querySelectorAll('a[href*="#"]'));
var addSmoothSckroll = function addSmoothSckroll() {
